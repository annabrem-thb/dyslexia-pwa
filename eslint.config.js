...
export default defineConfig([
  ...
  // Everything here runs under Node (Netlify Functions, Playwright/build
  // config, maintainer scripts), never in a browser — `require`/`exports`/
  // `process` are Node's CommonJS/runtime globals, not `browser` ones,
  // which is what the top block above the rest of the repo uses.
  {
    files: [
      'netlify/**/*.js',
      'scripts/**/*.js',
