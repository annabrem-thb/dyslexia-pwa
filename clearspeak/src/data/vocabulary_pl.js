export const wordDatabasePL = {
  ...
  vocabulary: [
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'definicje terminów zawodowych — edukacja',
      question: {
      ...
      options: [
        { text: 'Certyfikat', isCorrect: true, icon: '🎓' },
        { text: 'Regulamin', isCorrect: false, icon: '❌' },
        { text: 'Protokół', isCorrect: false, icon: '❌' },
        { text: 'Formularz', isCorrect: false, icon: '❌' },
      ],
    },
    {
      id: 38,
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'definicje terminów zawodowych — IT',
      question: {
      ...
      options: [
        ...
        { text: 'Wirus', isCorrect: false, icon: '❌' },
        { text: 'Program', isCorrect: false, icon: '❌' },
        { text: 'Ekran', isCorrect: false, icon: '❌' },
      ],
    },
    {
      id: 48,
      ...
      options: [
        { text: 'Zysk', isCorrect: true, icon: '📊' },
        { text: 'Przychód', isCorrect: false, icon: '❌' },
        { text: 'Podatek', isCorrect: false, icon: '❌' },
        { text: 'Rabat', isCorrect: false, icon: '❌' },
      ],
    },
    {
      ...
      options: [
        { text: 'Umowa', isCorrect: true, icon: '📝' },
        { text: 'Faktura', isCorrect: false, icon: '❌' },
        { text: 'Regulamin', isCorrect: false, icon: '❌' },
        { text: 'Protokół', isCorrect: false, icon: '❌' },
      ],
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'definicje terminów zawodowych — HR',
      question: {
      ...
      options: [
        { text: 'Rekrutacja', isCorrect: true, icon: '👥' },
        { text: 'Awans', isCorrect: false, icon: '❌' },
        { text: 'Zwolnienie', isCorrect: false, icon: '❌' },
        { text: 'Urlop', isCorrect: false, icon: '❌' },
      ],
    },
    {
      id: 51,
  ...
  patternCompletion: [
    {
      ...
      type: 'grapheme',
      difficulty: 1,
      focus: 'uzupełnianie wzoru wizualnego',
      question: {
