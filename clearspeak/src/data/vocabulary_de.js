export const wordDatabaseDE = {
  ...
  vocabulary: [
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'Definitionen von Fachbegriffen — Bildung',
      question: {
      ...
      options: [
        { text: 'Zertifikat', isCorrect: true, icon: '🎓' },
        { text: 'Vorschrift', isCorrect: false, icon: '❌' },
        { text: 'Protokoll', isCorrect: false, icon: '❌' },
        { text: 'Formular', isCorrect: false, icon: '❌' },
      ],
    },
    {
      id: 32,
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'Definitionen von Fachbegriffen — IT',
      question: {
      ...
      options: [
        ...
        { text: 'Programm', isCorrect: false, icon: '❌' },
        { text: 'Bildschirm', isCorrect: false, icon: '❌' },
      ],
    },
    {
      id: 42,
      ...
      options: [
        { text: 'Gewinn', isCorrect: true, icon: '📊' },
        { text: 'Umsatz', isCorrect: false, icon: '❌' },
        { text: 'Steuer', isCorrect: false, icon: '❌' },
        { text: 'Rabatt', isCorrect: false, icon: '❌' },
      ],
    },
    {
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'Definitionen von Fachbegriffen — Personalwesen',
      question: {
      ...
      options: [
        { text: 'Rekrutierung', isCorrect: true, icon: '👥' },
        { text: 'Beförderung', isCorrect: false, icon: '❌' },
        { text: 'Kündigung', isCorrect: false, icon: '❌' },
  ...
  patternCompletion: [
    {
      ...
      type: 'grapheme',
      difficulty: 1,
      focus: 'visuelle Musterergänzung',
      question: {
