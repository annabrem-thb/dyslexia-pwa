export default {
  ...
  a11y: {
    ...
    contrast: { name: 'Wysoki kontrast', desc: 'Czarno-białe kolory WCAG AAA' },
    motor: { name: 'Wygodne przyciski', desc: 'Powiększone przyciski i spokojne animacje' },
    vision: { name: 'Większy tekst', desc: 'Powiększona czcionka i ikony' },
    colors: { name: 'Bezpieczne kolory', desc: 'Zoptymalizowana, czytelna paleta barw' },
    motion: { name: 'Spokojny ekran', desc: 'Brak migotania i rozpraszającego ruchu' },
    ruler: { name: 'Linijka skupienia', desc: 'Podświetla poziomą linię pod kursorem' },
    spacing: { name: 'Większe odstępy', desc: 'Zwiększa odstępy między literami i słowami' },
    desaturation: { name: 'Łagodne barwy', desc: 'Zmniejsza nasycenie jaskrawych kolorów' },
  },
  inclusive: {
  ...
  bionicExplanation: "Bionic Reading® to metoda typograficzna wspierająca płynność czytania.",
  profiles: {
    standard: { name: "Standard", desc: "Widok domyślny" },
    lrs: { name: "Przyjazna czcionka", desc: "Czcionka ułatwiająca czytanie" },
    contrast: { name: "Wysoki Kontrast", desc: "Lepsza czytelność" },
    motor: { name: "Wygodne przyciski", desc: "Większe przyciski i spokojne animacje" },
    vision: { name: "Większy tekst", desc: "Powiększona czcionka i ikony" },
    colors: { name: "Bezpieczne kolory", desc: "Zoptymalizowana, czytelna paleta barw" },
    motion: { name: "Spokojny ekran", desc: "Brak migotania, brak rozpraszającego ruchu" },
    bionic: { name: "Bionic Reading", desc: "Pogrubia początki wyrazów" },
    ruler: { name: "Linijka skupienia", desc: "Podświetla poziomą linię pod kursorem" },
    spacing: { name: "Większe odstępy", desc: "Zwiększa odstępy między literami i słowami" },
    desaturation: { name: "Łagodne barwy", desc: "Zmniejsza nasycenie jaskrawych kolorów" }
  },
  accDescriptions: { standard: "Widok domyślny", contrast: "Tryb wysokiego kontrastu", lrs: "Przyjazna czcionka", motor: "Wygodne przyciski" },
  ...
  commands: {
    ...
    undo: ["cofnij", "wróć", "usuń", "przywróć"],
    skip: ["pomiń", "nie wiem"],
